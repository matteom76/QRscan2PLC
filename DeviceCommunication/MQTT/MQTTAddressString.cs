...
{
    public class MQTTAddressString : Notifier, IAddressString
    {
        ...
        public MQTTAddressString()
        {
            Topic = "";
        }

        public MQTTAddressString(string topic)
        {
            Topic = topic;
        }


        public MQTTAddressString(JObject adrData)
        {
            try
            {
