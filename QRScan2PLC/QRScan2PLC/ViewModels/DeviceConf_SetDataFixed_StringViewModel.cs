...
{
    public class DeviceConf_SetDataFixed_StringViewModel : BindableBase, IRegionAware
    {
        public DelegateCommand VisibleSelectCmd { get; private set; }

        private SetDataFixed<string> _property;
        public SetDataFixed<string> Property { get => _property; set => SetProperty(ref _property, value); }
        ...
        public DeviceConf_SetDataFixed_StringViewModel()
        {
        ...
        public void OnNavigatedTo(INavigationContext navigationContext)
        {
            ...
            Property = (SetDataFixed<string>)propertyFactory;
