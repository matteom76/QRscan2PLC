...
{
    public class DeviceConf_SetDataFixed_IntViewModel : BindableBase, IRegionAware
    {
        public DelegateCommand VisibleSelectCmd { get; private set; }

        private SetDataFixed<int> _property;
        public SetDataFixed<int> Property { get => _property; set => SetProperty(ref _property, value); }
        ...
        public DeviceConf_SetDataFixed_IntViewModel()
        {
        ...
        public void OnNavigatedTo(INavigationContext navigationContext)
        {
            ...
            Property = (SetDataFixed<int>)propertyFactory;
